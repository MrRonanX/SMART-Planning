...
struct PageTextContent {
    ...
    static let page2 = PageText(id: 2, image: IntroIllustrations.specific.image, title: "A specific goal answers following questions:", text: "• What steps will you take to achieve it? \n• Who is responsible for it? \n\nSometimes it's worth breaking a goal into few subgoals.", color: Colors.brandGrassGreen.color)
